                ...
                <Container>
                    <Row>
                        <Col xs={6} className="p-3">
                            <Row>
                                <h1 style={{ fontSize: "75px", fontWeight: "bold" }}>Welcome to NKG Graphics!</h1>
                            </Row>
                            <Row>
                                <p>
