...
export default function Checkout(props) {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:5000/users/getUser", { params: { email: isLogged.email } }).then((response) => {
            ...
            setGST(prov[0].GST);
            setGSTPrice((prov[0].GST / 100) * total);
            setPST(prov[0].PST);
            setPSTPrice((prov[0].PST / 100) * total);
        });
    }, grandTotalBeforeTax);
    ...
    function handleBillingChange(e) {
        ...
        if (name === "province") {
            ...
            setGST(prov[0].GST);
            setGSTPrice((prov[0].GST / 100) * grandTotalBeforeTax);
            setPST(prov[0].PST);
            setPSTPrice((prov[0].PST / 100) * grandTotalBeforeTax);
        }
    }
            ...
            <Jumbotron className="mb-0" fluid>
                <Container>
                    ...
                    <Row>
                        <Col>
                            <p>
                                Please confirm your billing address, payment method, and the order summary before
                                placing your order. Once the order has been placed, you will receive an email
                                confirmation, followed by a date/time when you can come to pickup your order.
                            </p>
                        </Col>
                    </Row>
                </Container>
            ...
            <Container>
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                    ...
                    <Row>
                        ...
                        <Col xs={4} className="mt-3 ml-3" style={{ border: "1px solid black", borderRadius: "20px" }}>
                            <b>Order Summary</b>
                            ...
                            <Table>
                                ...
                                <tr>
                                    ...
                                    <td style={{ textAlign: "right" }}>
                                        <b>{CAD.format(grandTotalBeforeTax + GSTPrice + PSTPrice)}</b>
                                    </td>
                                </tr>
                            </Table>
